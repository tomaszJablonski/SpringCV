...
<head>
    ...
    <link href='<c:url value="https://fonts.googleapis.com/css?family=Montserrat:400,700"/>' rel="stylesheet"
          type="text/css"/>
    <link href='<c:url value="https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic"/>'
...
<nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="#page-top">Dzień dobry</a>
...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src='<c:url value="resources/assets/img/avataaars.svg"/>' alt="..."/>
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Tomasz Jabłoński</h1>
        <!-- Icon Divider-->
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">Witam w moim interaktywnym CV</p>
    </div>
</header>
<!-- Portfolio Section-->
